...
resource_owner_key = fetch_response.get('2417784996-F1EHNFFWrdNtSQD1iOefMWoXNKknEwgvvDDkfXl')
resource_owner_secret = fetch_response.get('vVLfCAIxlQ6LqJp9Vxeg0ChIUJh2VGn6mpztBOLZ4ttWx')
...
resource_owner_key = oauth_tokens.get('2417784996-F1EHNFFWrdNtSQD1iOefMWoXNKknEwgvvDDkfXl')
resource_owner_secret = oauth_tokens.get('vVLfCAIxlQ6LqJp9Vxeg0ChIUJh2VGn6mpztBOLZ4ttWx')
